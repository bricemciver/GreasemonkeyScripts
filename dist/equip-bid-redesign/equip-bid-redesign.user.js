  ...
  ;(EquipBidRedesign2 => {
    ...
    EquipBidRedesign2.addFocusStyling = () => {
      ...
      ;(_a = styleEl.sheet) == null
        ? void 0
        : _a.insertRule('li.list-group-item.focused{outline: Highlight auto 1px; outline:-webkit-focus-ring-color auto 1px;}')
    }
      ...
      fetch(href)
        ...
        .then(data => {
          ...
          entries.forEach(entry => {
            ...
            if (
              (_b = (_a = entry.previousElementSibling) == null ? void 0 : _a.previousElementSibling) == null
                ? void 0
                : _b.previousElementSibling
            ) {
              listGroupItem.appendChild(
                (_d = (_c = entry.previousElementSibling) == null ? void 0 : _c.previousElementSibling) == null
                  ? void 0
                  : _d.previousElementSibling,
              )
            }
