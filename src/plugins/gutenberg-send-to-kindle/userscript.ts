...
const HTTP_OK = 200
const ensureStatus = (response: Tampermonkey.Response<unknown>, expectedStatus: number = HTTP_OK): void => {
...
const addSendToKindleButton = () => {
  ...
  let epubLink: HTMLAnchorElement | null = null
  const epubLinks = document.querySelectorAll<HTMLAnchorElement>('a[class*="link"][title*="Download"]')
